...
import { Clock, ChevronRight, ChevronLeft, Sun, Moon, Briefcase, Coffee, Sparkles, X, Check, Share2, TrendingUp, TrendingDown, Trash2, CalendarDays, Activity } from 'lucide-react';
    ...
    <div className="pt-2 px-5 pb-24 animate-fade-in font-sans relative compact-mode-padding">
      ...
      <div className="flex justify-between items-center mb-4 pt-2">
         <div>
            <div className="flex items-center gap-2 mb-1">
               ...
               <span className="text-[10px] font-bold text-gray-500 tracking-widest">TIMETRACKER</span>
            </div>
      ...
      <div className="flex gap-3 mb-3">
         ...
         >
            ...
            <div className="absolute bottom-3 right-3 text-gray-300 group-hover:text-teal-500 opacity-100 group-hover:scale-110 group-active:rotate-45 transition-all duration-300">
               <Sun size={20} />
            </div>
            
            {/* Decoration */}
            <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-teal-50 rounded-full blur-xl pointer-events-none group-hover:bg-teal-100 transition-colors" />
         </button>
         ...
         >
            ...
            <div className="absolute bottom-3 right-3 text-gray-300 group-hover:text-indigo-500 opacity-100 group-hover:scale-110 group-active:-rotate-45 transition-all duration-300">
               <Moon size={20} />
            </div>
            
            {/* Decoration */}
            <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-indigo-50 rounded-full blur-xl pointer-events-none group-hover:bg-indigo-100 transition-colors" />
         </button>
      </div>
      ...
      <div className="flex gap-3 mb-5">
         ...
         <div className="flex-1 bg-white rounded-[20px] px-5 py-3 flex flex-col justify-center shadow-lg shadow-blue-900/5 relative overflow-hidden group transition-all hover:shadow-xl border border-transparent focus-within:border-blue-100 focus-within:ring-4 focus-within:ring-blue-50/50">
            ...
            <div className="absolute top-3 right-3 text-gray-200 group-hover:text-blue-500 group-hover:scale-110 transition-all duration-500 pointer-events-none">
                <Briefcase size={16} strokeWidth={2} />
            </div>
            <label className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-0.5 relative z-10 group-focus-within:text-blue-500 transition-colors duration-300">
                Norma
            </label>
            <div className="flex items-baseline gap-1 relative z-10">
               <input 
                  ...
                  className="w-full text-lg font-light text-gray-800 bg-transparent outline-none p-0 m-0 placeholder-gray-300"
               />
         ...
         {/* Prestávka Input */}
         <div className="flex-1 bg-white rounded-[20px] px-5 py-3 flex flex-col justify-center shadow-lg shadow-blue-900/5 relative overflow-hidden group transition-all hover:shadow-xl border border-transparent focus-within:border-orange-100 focus-within:ring-4 focus-within:ring-orange-50/50">
            <div className="absolute -right-6 -bottom-6 w-16 h-16 bg-orange-50 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none" />
            <div className="absolute top-3 right-3 text-gray-200 group-hover:text-orange-500 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 pointer-events-none">
                <Coffee size={16} strokeWidth={2} />
            </div>
            <label className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mb-0.5 relative z-10 group-focus-within:text-orange-500 transition-colors duration-300">Pauza</label>
            <div className="flex items-baseline gap-1 relative z-10">
               <input 
                  type="number" 
                  value={breakMinutes}
      ...
      >
         ...
         <div className="absolute inset-0 rounded-[20px] border border-white/10 group-hover:border-white/20 transition-all duration-500" />

         <div className="relative z-10 flex items-center justify-center gap-3 text-white">
            {isAnalyzing ? (
                <>
                    <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                    <span className="font-bold tracking-wider text-xs uppercase">Analyzujem...</span>
                </>
            ) : (
                <>
                    <span className="font-bold text-base tracking-wide">Vytvoriť Prehľad</span>
                    <Sparkles size={18} className="text-blue-300 group-hover:text-white group-hover:rotate-12 transition-all duration-300" />
                </>
            )}
         </div>
         {isAnalyzing && (
          ...
          <div className="relative w-full rounded-[32px] bg-white/60 backdrop-blur-xl border border-white p-1 overflow-hidden shadow-2xl shadow-blue-900/10 group">
              ...
              <div className="bg-white/40 rounded-[28px] p-4 relative z-10">
                  ...
                  <div className="flex justify-between items-center mb-4">
                      ...
                      <div className="text-[9px] font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded-full border border-blue-100 shadow-sm">
      ...
      <div className="fixed inset-0 z-[100] flex items-end justify-center">
         ...
         <div className="bg-white w-full max-w-lg rounded-t-[32px] p-6 pb-8 z-10 shadow-2xl transform transition-transform animate-slide-up relative overflow-hidden">
             ...
             <div className="relative h-48 flex justify-center gap-2 mb-8 select-none">
                ...
                <div 
                   ref={hoursRef}
                   className="w-24 h-full overflow-y-auto no-scrollbar py-[72px] text-center snap-y snap-mandatory relative z-10 mask-gradient"
                >
                   {hourOptions.map(h => (
                      <div 
                         key={h}
                         data-value={h}
                         onClick={() => setHours(h)}
                         className={`h-12 flex items-center justify-center text-2xl transition-all snap-center cursor-pointer
